...
using Task = Task_Mangement.Models.Task;
...
namespace Task_Mangement.Controllers
{
    public class NewTaskController : Controller
    {
        ...
        public NewTaskController(SampleDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TaskId,TaskTitle,TaskStatus,TaskDescription,TaskDueDate")] Task task)
        {
